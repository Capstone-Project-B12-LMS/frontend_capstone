...
const Home = () => {
  ...
  return (
    <div className="w-full mt-8">
      <HeaderClass />
      {
        !teacher?.length && !teacherInactive?.length ?

          <p className="text-slate-300 text-3xl text-center mt-60 leading-[4rem]">Sorry we can't display any class <br/> Please create the class first</p>
