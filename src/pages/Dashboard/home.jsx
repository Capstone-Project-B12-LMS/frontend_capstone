        ...
        <>
            {
                ...
                <div className="flex flex-col items-center my-18 mx-auto">
                    ...
                    <div className="mt-8">
                        <Button 
                            text="Join Class"
                            styling='text-normal font-medium px-6 py-2 rounded-[20px] mr-4 border hover:bg-transparent hover:text-[#415A80] hover:border-[#415A80]'
                            handleClick={joinClass}
                        />
                        <Button 
                            text="Create Class"
                            styling='text-normal font-medium px-6 py-2 rounded-[20px] border border-[#415A80] text-[#415A80] bg-transparent hover:bg-[#415A80] hover:text-white'
                            handleClick={createClass}
                        />
                    </div>
                </div>
