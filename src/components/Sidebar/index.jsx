...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div className={`fixed inset-0 w-screen height-screen bg-[rgba(0,0,0,0.5)] inset-y-0 ease-[0.5s cubic-bezier(0.250, 0.460, 0.450, 0.940)] duration-500 ${isOpen ? 'left-0' : 'left-[-100vw]'}`}>
      <aside ref={ref} className={`flex flex-col justify-items-center w-[320px] h-screen pb-10 bg-light-blue fixed`} >
